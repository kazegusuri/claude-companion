...
test.describe.serial("Chat Display Scrolling and Message Limit", () => {
  ...
  test("should handle 30 messages without breaking layout and show scrollbar", async ({ page }) => {
  ...
  test("should clear messages when clicking clear button", async ({ page }) => {
    ...
    messageCount = await page.locator('[data-testid="chat-scroll-area"] [class*="Paper"]').count();
